...
## Acceptance Criteria
- [ ] Implement at least one approach from above
- [ ] Test on images with known occluded circles
- [ ] Detection rate for occluded circles ≥70%
- [ ] False positive rate increase <20%
- [ ] Document parameter tuning recommendations

## Implementation Tasks
- [ ] Create test dataset with occluded circle examples
- [ ] Implement arc detection algorithm
- [ ] Add morphological preprocessing option
- [ ] Tune Hough parameters for partial circles
- [ ] Benchmark detection accuracy
- [ ] Add CLI flag for occluded-circle mode (if needed)
