...
| :--- | :--- | :--- | :--- | :---: |
| **Bullseye cluster renderer** | feature | P0 | feature.md | - [x] Card created (qm8cnj) |
| **CLI --reconstitute flag** | feature | P1 | feature.md | - [x] Card created (tx0wkk) |
| **Sprint close-out verification** | chore | P2 | chore.md | - [x] Card created (q9pfom) |
