...
## Acceptance Criteria
- [ ] New `--chunk-size` CLI flag to set tile dimensions (default: auto-calculated)
- [ ] Tiles overlap by `max_radius` pixels to catch boundary circles
- [ ] Each tile processed independently (parallel-ready architecture)
- [ ] Boundary circles merged using spatial proximity matching
- [ ] Progress reporting: "Processing tile 3/16..."
- [ ] Benchmark: 38 MP image processes in <5 minutes with chunking
- [ ] No duplicate circles at tile boundaries
