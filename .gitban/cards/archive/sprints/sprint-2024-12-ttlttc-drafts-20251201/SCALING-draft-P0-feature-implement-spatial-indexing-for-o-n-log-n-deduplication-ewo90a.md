...
## Acceptance Criteria
- [ ] Implement KD-tree based spatial indexing using `scipy.spatial.KDTree`
- [ ] Replace nested loop deduplication with `query_ball_point()` for O(n log n) neighbor searches
- [ ] Maintain identical deduplication behavior (same distance threshold, same merge logic)
- [ ] Add unit tests comparing results of old vs new deduplication
- [ ] Benchmark: 10,000 circles should deduplicate in <1 second
- [ ] Benchmark: 50,000 circles should deduplicate in <10 seconds
