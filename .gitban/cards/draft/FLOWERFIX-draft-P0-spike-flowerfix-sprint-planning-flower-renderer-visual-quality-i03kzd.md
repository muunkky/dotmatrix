...
| :--- | :--- | :--- | :--- | :--- | :---: |
| **Technical design: petal geometry math** | spike | P0 | spike-technical-design | TODO | - [ ] Card created |
| **Fix black circle clipping and z-order** | bug | P0 | bug | TODO | - [ ] Card created |
| **Fix petal geometry for shallower arcs** | bug | P0 | bug | TODO | - [ ] Card created |
| **Assumptions document** | docs | P1 | docs | TODO | - [ ] Card created |
| **Sprint close-out verification** | chore | P1 | chore | TODO | - [ ] Card created |
...
| **Cards Created** | 5 cards (4 immediate sprint, 1 deferred) |
| **Issues Deferred** | 1 issue (CLI flag for petal distance) |
