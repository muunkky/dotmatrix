...
def calculate_bar_dimensions(
    ...
    """
    # Get pixel counts for all 7 colors
    counts = {
...
def render_single_block(
    ...
    bounds = calculate_bar_dimensions(cluster, segment_height=segment_height)
...
def render_blocks(
    ...
    for cluster in clusters:
        ...
        render_single_block(cluster, output, segment_height=segment_height)
